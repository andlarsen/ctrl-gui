...
def main():
    ...
    ce.tfs['G1'].add_constant('zeta',0.7)
    # ce.tfs['G1'].define_tf_from_equation('ddot(y)+2*zeta*w_n*dot(y)+w_n**2*y','u')
    # ce.tfs['G1'].define_tf_from_string('1/(s**2 + 2*w_n*zeta*s + w_n**2)')
