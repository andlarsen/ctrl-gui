...
class TransferFunctionObject(TransferFunctionModel):
    def __init__(self, name, description, global_symbols, global_constants):
        # super().__init__(name, description, global_symbols, global_constants)
        super().__init__(name=name, description=description)

# class TransferFunctionObject:
#     def __init__(self, name, description, global_symbols, global_constants):
#         self = TransferFunctionModel()
        ...
        # self.gm = None
        # self.pm = None
        # self.impulse_response = ResponseModel(response_type='impulse')
        # self.step_response = ResponseModel(response_type='step')
        # self.ramp_response = ResponseModel(response_type='ramp')
        # self.define_input('u')
...
#         self.functions.append(self.input[0])
#         self.functions.append(self.input[1])

#     def define_output(self, name: str):
#         self.output = defs_sympy.add_function(name)
#         self.functions.append(self.output[0])
#         self.functions.append(self.output[1])
...
#         pass
    ...
    #         # From string
    #         self.symbolic = defs_tf.from_string(args[0], self.constants)
...
#             else:
#                 fb = TransferFunctionObject(name=name,description='Unit feedback',global_symbols=[],global_constants={})
#                 fb.define_tf('1') 
